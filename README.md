...
`Java` `JavaScript` `Python` `React` `Node.js` `Express` `FastAPI`

### Currently into

Building useful products, backend systems, AI-powered ideas & solving problems that make me question my life choices (I am dumbass)(muheheheh),
